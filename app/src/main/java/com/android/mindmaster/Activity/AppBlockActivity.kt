...
//install app will get load
    /*
    loading app layout will be visible
    app block layout non visible
   data(apps) store in appblockmodule
     */
...
//after loading of apps then all data will stoded in recycler view
        @Deprecated("Deprecated in Java")
